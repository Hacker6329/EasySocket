...
#include <stdio.h>
#include <string.h>
#define EASY_SOCKET_LOCAL_ADDRESS "127.0.0.1"
#define EASY_SOCKET_USE_DEPRECATED 0
    ...
    //Functions Pre-Declaration: TCPwod
    int tcp_init_client(EasySocket* socketStructure, const char* serviceName, int servicePort, struct sockaddr_in* local, struct sockaddr_in* remote);
    int tcp_init_client_with_timeout(EasySocket* socketStructure, const char* serviceName, int servicePort, struct sockaddr_in* local, struct sockaddr_in* remote, int timeoutmillis);
	...
	int udp_init_client(EasySocket* socketStructure, const char* serviceName, int servicePort, struct sockaddr_in* local, struct sockaddr_in* remote);
    int udp_init_client_with_timeout(EasySocket* socketStructure, const char* serviceName, int servicePort, struct sockaddr_in* local, struct sockaddr_in* remote, int timeoutmillis);
